...
class ReportService:
    ...
    def report(self, predictions, rounded_predictions, labels_data, record_ids):
        ...
        self.print_error_stats(record_ids, labels_data, predictions, rounded_predictions)

    @staticmethod
    def print_error_stats(record_ids, labels_data, predictions, rounded_predictions):
